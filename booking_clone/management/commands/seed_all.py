...
class Command(BaseCommand):
    ...
    def handle(self, *args, **options):
        ...
        room1 = Room.objects.create(
            hotel=hotel1, number='101', room_type=standard,
            price=150.00, is_available=True, max_guests=2
        )
        room1.amenities.set([wifi, ac, tv, coffee])
        
        room2 = Room.objects.create(
            hotel=hotel1, number='102', room_type=deluxe,
            price=220.00, is_available=True, max_guests=2
        )
        room2.amenities.set([wifi, ac, tv, minibar, safe, coffee, balcony])
        
        room3 = Room.objects.create(
            hotel=hotel1, number='201', room_type=suite,
            price=450.00, is_available=True, max_guests=4
        )
        room3.amenities.set([wifi, ac, tv, minibar, safe, coffee, balcony, bathtub])
        
        # Hotel 2 - Eiffel Tower
        room4 = Room.objects.create(
            hotel=hotel2, number='301', room_type=deluxe,
            price=280.00, is_available=True, max_guests=2
        )
        room4.amenities.set([wifi, ac, tv, minibar, safe, coffee, balcony])
        
        room5 = Room.objects.create(
            hotel=hotel2, number='401', room_type=penthouse,
            price=850.00, is_available=True, max_guests=6
        )
        room5.amenities.set([wifi, ac, tv, minibar, safe, coffee, balcony, bathtub])
        
        # Hotel 3 - Tokyo
        room6 = Room.objects.create(
            hotel=hotel3, number='205', room_type=standard,
            price=120.00, is_available=True, max_guests=2
        )
        room6.amenities.set([wifi, ac, tv])
        
        room7 = Room.objects.create(
            hotel=hotel3, number='305', room_type=family,
            price=200.00, is_available=True, max_guests=4
        )
        room7.amenities.set([wifi, ac, tv, coffee])
        
        # Hotel 4 - London
        room8 = Room.objects.create(
            hotel=hotel4, number='110', room_type=deluxe,
            price=190.00, is_available=True, max_guests=2
        )
        room8.amenities.set([wifi, ac, tv, minibar, coffee])
        
        room9 = Room.objects.create(
            hotel=hotel4, number='210', room_type=suite,
            price=380.00, is_available=False, max_guests=4
        )
        room9.amenities.set([wifi, ac, tv, minibar, safe, coffee, balcony, bathtub])
        
        # Hotel 5 - Rome
        room10 = Room.objects.create(
            hotel=hotel5, number='101', room_type=standard,
            price=140.00, is_available=True, max_guests=2
        )
        room10.amenities.set([wifi, ac, tv])
        
        room11 = Room.objects.create(
            hotel=hotel5, number='202', room_type=deluxe,
            price=210.00, is_available=True, max_guests=2
        )
        room11.amenities.set([wifi, ac, tv, minibar, safe, coffee, balcony])
        
        # Hotel 6 - Barcelona
        room12 = Room.objects.create(
            hotel=hotel6, number='505', room_type=suite,
            price=420.00, is_available=True, max_guests=4
        )
        room12.amenities.set([wifi, ac, tv, minibar, safe, coffee, balcony, bathtub])
        
        room13 = Room.objects.create(
            hotel=hotel6, number='101', room_type=standard,
            price=130.00, is_available=True, max_guests=2
        )
        room13.amenities.set([wifi, ac, tv])
        
        # Hotel 7 - Berlin
        room14 = Room.objects.create(
            hotel=hotel7, number='303', room_type=deluxe,
            price=180.00, is_available=True, max_guests=2
        )
        room14.amenities.set([wifi, ac, tv, minibar, coffee])
        
        room15 = Room.objects.create(
            hotel=hotel7, number='404', room_type=family,
            price=250.00, is_available=True, max_guests=4
        )
        room15.amenities.set([wifi, ac, tv, minibar, safe, coffee])
        
        # Hotel 8 - Dubai
        room16 = Room.objects.create(
            hotel=hotel8, number='1001', room_type=penthouse,
            price=1200.00, is_available=True, max_guests=6
        )
        room16.amenities.set([wifi, ac, tv, minibar, safe, coffee, balcony, bathtub])
        
        room17 = Room.objects.create(
            hotel=hotel8, number='801', room_type=suite,
            price=650.00, is_available=True, max_guests=4
        )
        room17.amenities.set([wifi, ac, tv, minibar, safe, coffee, balcony, bathtub])
        
        # Hotel 9 - NY Harbor
        room18 = Room.objects.create(
            hotel=hotel9, number='105', room_type=standard,
            price=110.00, is_available=True, max_guests=2
        )
        room18.amenities.set([wifi, ac, tv])
        
        room19 = Room.objects.create(
            hotel=hotel9, number='205', room_type=deluxe,
            price=170.00, is_available=True, max_guests=2
        )
        room19.amenities.set([wifi, ac, tv, minibar, coffee, balcony])
        
        # Hotel 10 - Louvre
        room20 = Room.objects.create(
            hotel=hotel10, number='201', room_type=deluxe,
            price=240.00, is_available=True, max_guests=2
        )
        room20.amenities.set([wifi, ac, tv, minibar, safe, coffee])
        
        room21 = Room.objects.create(
            hotel=hotel10, number='301', room_type=suite,
            price=480.00, is_available=True, max_guests=4
        )
        room21.amenities.set([wifi, ac, tv, minibar, safe, coffee, balcony, bathtub])
